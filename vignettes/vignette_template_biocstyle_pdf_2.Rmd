...
Le tableau \@ref(tab:tab2)  permet de visualiser les diverses options relatives à la division des théorèmes dans _bookdown_.


```{r tab2, tab.cap="Division des théorèmes dans bookdown"}
 kableExtra::kbl(
